...
def read_sql_file(arquivo_sql, arquivo_json):
    ...
    for match in tabela_pattern.finditer(sql):
        ...
        for coluna_match in coluna_pattern.finditer(colunas):
            ...
            dictionary[nome_tabela]["colunas"][nome_coluna] = tipo_coluna
        ...
        for foreign_key_match in foreign_key_pattern.finditer(colunas):
            ...
            dictionary[nome_tabela]["relacionamentos"][tabela_referenciada] = relacionamento
...
# Exemplo de uso
resultado = read_sql_file('/home/lenovo/dumps/Dump20250209.sql', 'schema_database/dictionary.json')
print(resultado)
# ```
...
# ```python
# resultado = read_sql_file('seu_arquivo.sql', 'resultado.json')
# print(resultado)
# ```
